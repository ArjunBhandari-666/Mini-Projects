...
void start_game()
{
    ...
    displayRasterText(-70,250, 2.5, "3D DINO");
    glLineWidth(10);
    glColor3f(0, 1, 0);
...
void display2()
{
    ...
    case GAME:
        ...
        id3=glutCreateWindow("Dino Light 3D");
...
void key1(unsigned char key,int x,int y)
{
    ...
    if(key=='S')
    {
        ...
        id2=glutCreateWindow("Start Screen");
